...
export class UploadingContracts1696407367476 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "contract_source_files" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "contract_id" character varying(63) NOT NULL, "file_path" character varying(127) NOT NULL, "content" character varying NOT NULL, CONSTRAINT "PK_0d6efaaf4d2908d5c38895acfc4" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
